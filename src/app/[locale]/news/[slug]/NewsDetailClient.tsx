...
// --- Styled Components (Giữ nguyên của anh) ---
    ...
    <PageWrapper>
      <Container>
        ...
        <FadeInWhenVisible>
          <ArticleCard>
            <ImageContainer>
              <Image src={newsData.coverImage || '/images/placeholder.jpg'} alt={translation.title} fill priority sizes="(max-width: 900px) 100vw, 900px" style={{ objectFit: 'cover' }} />
            </ImageContainer>
